...
const commands = [
	...
	{
		name: 'timeout',
		description: 'Timeout a user for a specified duration (costs 500k * duration + 10% of balance, 5 min cooldown)',
		options: [
			{
				name: 'user',
...
commands.push(pokeevolveformCommand.data.toJSON());
...
commands.push(pokemonshowCommand.data.toJSON());
